...
def abrir_video():
    link = "https://drive.google.com/file/d/14q94ljwtWrJOndEF28Pb0feV51cNKhpq/view?usp=sharing"
...
def criar_interface():
    ...
    carregar_xml_button = tk.Button(root, text="Arquivo SIAFI", command=carregar_xml, font=("Arial", 12), width=20, bg="#3498db", fg="white", relief="flat", cursor="hand2")
    ...
    carregar_xlsx_button = tk.Button(root, text="Arquivo Tesouro Gerencial", command=carregar_xlsx, font=("Arial", 12), width=20, bg="#3498db", fg="white", relief="flat", cursor="hand2")
    ...
    botao_video = tk.Button(root, text="Tutorial", command=abrir_video,
    font=("Arial", 11), bg="#8e44ad", fg="white", relief="flat", cursor="hand2")
